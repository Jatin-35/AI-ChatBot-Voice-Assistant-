...
def FirstLayerDMM(prompt : str = "test") :
    ...
    # Create a streaming chat sesion with the cohere model
    ...
    # Iterate over the events in the stream and capture the text generation exists
    for event in stream:
    ...
    # Strip leading and trailing whitespaces from each other
...
# Entry points for the script.
if __name__ == "__main__" :
    
    # Constinuously prompt the user for input and process it.
    while True :
