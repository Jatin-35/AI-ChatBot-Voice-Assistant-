...
def SetMicrophoneStatus(Comand) :
...
class CustomTopBar(QWidget):
    ...
    def __init__(self, parent, stacked_widget=None):
        super().__init__(parent)
    ...
    def initUI(self):
        ...
        minimize_button.setStyleSheet(self.controlButtonStyle())
        ...
        self.maximize_button.setStyleSheet(self.controlButtonStyle())
        self.maximize_button.clicked.connect(self.maximizeWindow)

        close_button = QPushButton()
        close_button.setIcon(QIcon(GraphicsDirectoryPath('Close.png')))
        close_button.setStyleSheet(self.controlButtonStyle("red"))
    ...
    def navButtonStyle(self):
        return (
            "QPushButton { background-color: white; color: black; padding: 5px 10px; "
            "border: 1px solid #ccc; border-radius: 5px; }"
            "QPushButton:hover { background-color: #f0f0f0; }"
        )

    def controlButtonStyle(self, hover_bg="lightgray"):
        return (
            f"QPushButton {{ background-color: white; border: none; padding: 5px; }}"
